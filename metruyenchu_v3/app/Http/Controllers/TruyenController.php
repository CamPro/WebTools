...
class TruyenController extends Controller{
    ...
    public static function getTruyenDaDang_DESC($num){
        return Truyen::join('thanh_viens', 'truyen.id', '=', 'thanh_viens.truyen_id')
    ...
    //trang chu
    public static function getTruyenVip($num){
        return Truyen::select('id', 'name', 'name_slug', 'cover', 'thumb', 'author', 'num_chaps', 'status', 'updated_at', 'num_chaps_pending')
        ->where('public', 'Y')
        ->where('delete', 'N')
        ->where('vip', 'Y')
    ...
    public static function getTruyenHot($num){
        return Truyen::select('id', 'name', 'name_slug', 'cover', 'thumb', 'author', 'num_chaps', 'status', 'vip', 'updated_at', 'num_chaps_pending')
        ->where('public', 'Y')
        ->where('delete', 'N')
        ->orderBy('vote', 'desc')
        ->paginate($num);
    ...
    public static function getTruyenVip_Home($num){
        return Truyen::select('id', 'name', 'name_slug', 'cover', 'thumb', 'author', 'num_chaps', 'status', 'vip', 'updated_at', 'num_chaps_pending')
        ->where('public', 'Y')
        ->where('delete', 'N')
        ->where('vip', 'Y')
    ...
    public static function getTruyenTheoTheLoai($name_slug, $num){
        ...
        ->select('truyen.name', 'truyen.name_slug', 'truyen.num_chaps', 'truyen.num_chaps_pending', 'truyen.cover', 'truyen.status', 'truyen.vip')
        ->paginate($num);
    }
    ...
    public static function countGetTruyenTheoTheLoai($name_slug){
        ...
        ->where('truyen.delete', '=', 'N')
        ->orderBy('truyen.views', 'desc')
        ->select('truyen.name', 'truyen.name_slug', 'truyen.num_chaps', 'truyen.num_chaps_pending', 'truyen.cover')
        ->count();
    }
    ...
    public static function getTruyenTuSach($num){
        return Truyen::join('tu_sach', 'tu_sach.truyen_id', '=', 'truyen.id')
            ...
            ->select('truyen.id', 'truyen.name', 'truyen.name_slug', 'truyen.author', 'truyen.status', 'truyen.num_chaps', 'truyen.cover', 'tu_sach.created_at', 'tu_sach.created_at', 'truyen.author', 'num_chaps_pending')
            ->paginate($num);
    }
    ...
    public static function getPaginate($number){
        return Truyen::orderBy('created_at', 'desc')->paginate($number);
    }
    ...
    public static function updateThemChapPending($truyen_id){
        $truyen = Truyen::find($truyen_id);
        $truyen->num_chaps_pending = ((int)$truyen->num_chaps_pending + 1);
        $truyen->timestamps = false;
        $truyen->save();
    }

    public static function updateXoaChapPending($truyen_id){
        $truyen = Truyen::find($truyen_id);
        $truyen->num_chaps_pending = ((int)$truyen->num_chaps_pending - 1);
        $truyen->save();
        ThongBaoController::getThongBaoTuSach($truyen_id);
    }

    public static function updateXoaChapPending_2($truyen_id){
        $truyen = Truyen::find($truyen_id);
        $truyen->num_chaps_pending = ((int)$truyen->num_chaps_pending - 1);
        $truyen->save();
    }
    ...
    public static function searchTruyen($name){
        return Truyen::where('name_slug', 'like', '%'.Str::slug($name).'%')
