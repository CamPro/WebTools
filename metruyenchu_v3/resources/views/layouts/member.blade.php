					...
					<div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
						...
						<div class="dropdown d-flex">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="{{ route('member.account') }}"><span class="dropdown-icon oi oi-person"></span> Hồ Sơ Cá Nhân</a>
				...
				<div class="aside-menu overflow-hidden">
					<nav id="stacked-menu" class="stacked-menu">
						<ul class="menu">
							...
							<li class="menu-item">
								<a href="{{ route('member.chuong_da_mua') }}" class="menu-link {{ ActiveLink2('chuong-da-mua', 'has-active') }}">
									<span class="menu-icon fas fa-list {{ ActiveLink2('chuong-da-mua', 'has-active') }}"></span>
									<span class="menu-text">Chương Đã Mua</span>
								</a>
							</li>
							<li class="menu-item">
							...
							<li class="menu-item">
								<a href="{{ route('member.naplinhthach') }}" class="menu-link {{ hasActive('nap-linh-thach') }}">
									<span class="menu-icon fa fa-sack-dollar"></span>
									<span class="menu-text">Nạp Linh Thạch</span>
								</a>
							</li>
							<li class="menu-item">
