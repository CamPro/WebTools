        ...
        <header class="page-title-bar">
            ...
            <div class="d-md-flex align-items-md-start">
                ...
                <div class="btn-toolbar">
                    <input type="text" class="form-control" id="search-stories" placeholder="Enter tìm truyện...">
                </div>
            </div>
        </header>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="TableStories" class="table">
...
<script>
    ...
    $('#search-stories').keyup(function(e) {
        if (e.keyCode == 13) {
            var keyword = $('#search-stories').val();
            $.ajax({
                url: "{{ route('admin.truyen.search') }}",
                data: {
                    key: keyword,
                },
                type: 'get',
                success: function(data_return) {
                    $('#getDataSearch').html(data_return);
                }
            });
        }
    })
