...
@section('content')
<input type="text" value="{{ $truyen->id }}" id="myIdTruyen" hidden>
<div class="page">
    ...
    <nav class="page-navs">
        <div class="nav-scroller">
            <div class="nav nav-center nav-tabs">
                ...
                <a class="nav-link {{ ActiveLink2('thanh-vien', 'active') }}" href="{{ route('member.dashboard.my_story.member', ['name_slug'=>$truyen->name_slug]) }}"><i class="fas fa-users"></i> Thành Viên</a>
                @if(getCraw() == 'Y')
