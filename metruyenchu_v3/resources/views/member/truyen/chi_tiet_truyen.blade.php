...
@section('title', 'Tổng Quan Truyện')
            ...
            <div class="col-xl-6">
                <div class="card card-fluid" style="height: 337px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-truncate">
                                        <a href="{{ route('trangchu.chuong', ['truyen'=>$truyen->name_slug, 'chuong'=>'chuong-'.$val->numchap]) }}" target="_blank">Chương {{ $val->numchap }}: {{ $val->name }}</a>
                                    </td>
                    ...
                    <div class="card-footer">
                        <a href="{{ route('member.dashboard.my_story.list_chapter', ['name_slug'=>$truyen->name_slug]) }}" class="card-footer-item">Xem tất cả <i class="fa fa-fw fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="card card-fluid" style="height: 337px;">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('member.story.diary', ['name_slug'=>$truyen->name_slug]) }}" class="card-footer-item">Xem tất cả <i class="fa fa-fw fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
