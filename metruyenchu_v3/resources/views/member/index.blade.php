                ...
                <div class="metric-row">
                    <div class="col-lg-9">
                        <div class="metric-row metric-flush">
                            <div class="col">
                                <a href="{{ route('member.dashboard.my_story') }}" class="metric metric-bordered align-items-center">
                            ...
                            <div class="col">
                                <a href="{{ route('member.bookmarks') }}" class="metric metric-bordered align-items-center">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card card-widget widget-user">
                        <div class="card-header frame-header-index" style="background: url('./public/images/tien-hiep-1.jpeg') center center;"></div>
                        <div class="widget-user-image frame-atavar-index user-avatar user-avatar-xl">
                    ...
                    <div class="card">
                        <div class="card-header my-0 pb-0">
                            <h3 class="card-title">
                                ...
                                <small class="float-right"><a href="{{ route('member.dashboard.my_story') }}">Xem tất cả</a></small>
                            </h3>
                        </div>
                            ...
                            <div class="container-frame-story">
                                ...
                                <div class="float-left ml-3">
                                    <h5 class="mb-1 font-weight-bold">
                                        <a href="{{ route('member.dashboard.my_story.detail', ['name_slug'=>$val->name_slug]) }}" style="color: #007bff;"><i class="fas fa-feather-alt"></i> {{ $val->name }}</a>
                                    </h5>
                                    ...
                                    <div class="frame-button-index mt-3">
                                        <a href="{{ route('member.dashboard.my_story.add_chapter', ['name_slug'=>$val->name_slug]) }}" class="btn btn-cam mr-1 {{ statusCheck($val['status']) }} {{ statusLock($val['lock']) }}">
                                            <i class="fas fa-plus"></i> Thêm Chương
                                        </a>
                                        <a href="{{ route('member.dashboard.my_story.list_chapter', ['name_slug'=>$val->name_slug]) }}" class="btn btn-xanh mr-1">
                                            <i class="far fa-list"></i> Danh Sách Chương
                                        </a>
                                        <a href="{{ route('member.dashboard.my_story.edit', ['name_slug'=>$val->name_slug]) }}" class="btn btn-xam">
                                            <i class="far fa-edit"></i> Sửa Truyện
                                        </a>
                                    </div>
                                </div>
                                <div class="cls"></div>
