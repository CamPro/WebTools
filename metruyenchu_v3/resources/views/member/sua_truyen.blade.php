...
<div class="page">
    <div class="page-inner">
        ...
        <div class="page-section">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="uploadForm" method="post" action="{{ route('member.dashboard.my_story.edit_post') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <select id="the_loai_truyen" class="form-control" data-toggle="select2" name="the_loai_truyen[]" data-placeholder="Chọn 1 hoặc nhiều thể loại trong đây" data-maximum-selection-length="10" multiple="true" required>
                                    {{ showSelectType($theloai_truyen, $truyen_theloai); }}
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="link_craw">Link craw</label>
                                <fieldset>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="link_craw" name="link_craw" maxlength="255" value="{{ $truyen->link_craw }}" placeholder="https://truyenfull.vn/thien-dao-phi-tien/" autocomplete="off">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="form-group">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="nguon" name="source" maxlength="{{ tbl_fields['truyen']['source'] }}" value="{{ $truyen->source }}" placeholder="http://metruyenchu.epizy.com" autocomplete="off">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
