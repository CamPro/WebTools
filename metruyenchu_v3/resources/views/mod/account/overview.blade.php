                ...
                <div class="col-12 col-sm-6 col-lg-2">
                    <div class="card-metric">
                        <div class="metric">
                            <h5 class="text-center">
                                <span class="user-avatar user-avatar-lg">
                                    <img src="{{ asset('public/images/books.png') }}" alt="" class="img-circle elevation-2" width="50">
                                </span>
                            </h5>
                ...
                <div class="col-12 col-sm-6 col-lg-2">
                    <div class="card-metric">
                        <div class="metric">
                            <h5 class="text-center">
                                <span class="user-avatar user-avatar-lg">
                                    <img src="{{ asset('public/images/book.png') }}" alt="" class="img-circle elevation-2" width="50">
                                </span>
                            </h5>
                ...
                <div class="col-12 col-sm-6 col-lg-2">
                    <div class="card-metric">
                        <div class="metric">
                            <h5 class="text-center">
                                <span class="user-avatar user-avatar-lg">
                                    <img src="{{ asset('public/images/comment-2.png') }}" alt="" class="img-circle elevation-2" width="50">
                                </span>
                            </h5>
            ...
            <div class="col-xl-6">
                <div class="card card-fluid" style="height: 337px;">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('mod.bookmarks') }}" class="card-footer-item">Xem tất cả <i class="fa fa-fw fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="card card-fluid" style="height: 337px;">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td class="align-middle" width="5">{{ $loop->index+1 }}</td>
                                    <td class="align-middle text-truncate">
                                        <a href="{{ route('mod.truyen_da_dang.chi_tiet', ['name_slug'=>$val->name_slug]) }}">{{ $val->name }}</a>
                                    </td>
                                    <td class="align-middle text-right">{{ $val->created_at->diffForHumans() }}</td>
                                </tr>
                                @endforeach
                    ...
                    <div class="card-footer">
                        <a href="{{ route('mod.truyen_da_dang') }}" class="card-footer-item">Xem tất cả <i class="fa fa-fw fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
