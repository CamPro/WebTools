...
Route::get('/truyen-vip', [HomeController::class, 'getTruyenVIP'])->name('trangchu.truyen_vip');
...
Route::post('/truyen/xoa-comment', [HomeController::class, 'ajaxDeleteComment'])->name('trangchu.xoa_binh_luan');
...
//Public info user
Route::get('/thanh-vien/{id}', [HomeController::class, 'getPublicInfoUser'])->name('trangchu.getPublicInfoUser');
...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/truyen-da-dang/{name_slug}/thanh-vien', [MemberController::class, 'getThanhVien'])->name('member.dashboard.my_story.member');
    ...
    //Ajax add thành viên truyện
    Route::get('/ajax-add-members-story', [ThanhVienController::class, 'ajaxThemThanhVien'])->name('member.add_members_story');

    //Ajax get thành viên truyện -> images
    Route::get('/ajax-get-images-members-story', [ThanhVienController::class, 'getThanhVien_Truyen'])->name('member.get_members_story');

    //Ajax xoa thành viên truyện
    Route::get('/ajax-delete-images-members-story', [ThanhVienController::class, 'ajaxXoaThanhVien'])->name('member.delete_members_story');
    ...
    Route::get('/dashboard/my-story/craw-ajax', [MemberController::class, 'ajax_CrawChuong'])->name('member.story.craw_ajax');
    Route::post('/dashboard/my-story/post-craw-save', [MemberController::class, 'postCrawChuong'])->name('member.story.craw_save');
    ...
    Route::get('/delete-notification', [MemberController::class, 'ajaxDeleteNotification'])->name('member.delete.notify');
    ...
    //Nạp linh thạch
    Route::get('/nap-linh-thach', [MemberController::class, 'getNapLinhThach'])->name('member.naplinhthach');
    Route::post('/post-nap-linh-thach', [MemberController::class, 'postNapLinhThach'])->name('member.naplinhthach.add');

    //Mua chương
    Route::get('/mua-chuong/{id}', [MemberController::class, 'getMuaChuong'])->name('member.mua_chuong');
    Route::get('/chuong-da-mua', [MemberController::class, 'getChuongDaMua'])->name('member.chuong_da_mua');
});
...
Route::prefix('admin')->middleware('admin')->group(function(){
    ...
    //Nạp tiền trực tuyến
    Route::get('/nap-tien-truc-tuyen', [AdminController::class, 'getNapTienTrucTuyen'])->name('admin.naptien');
    Route::get('/nap-tien-truc-tuyen/{id}', [AdminController::class, 'getUpdateTrangThaiHoaDon'])->name('admin.naptien.check_bill');
    Route::get('/nap-tien-cancel/{id}', [AdminController::class, 'getCancelNapTien'])->name('admin.naptien.cancel');
    Route::get('/truyen/vip/{id}', [AdminController::class, 'getUpdateTruyenVip'])->name('admin.truyen.vip');
    Route::get('/truyen/search-admin', [AdminController::class, 'ajaxSearchTruyen'])->name('admin.truyen.search');
});