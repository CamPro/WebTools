    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>TỰ ĐỘNG THỂ HIỆN CẢM XÚC TRÊN FANPAGE/ PROFILE</h2>
                    </div>
                    <div class="body">
					...
					?><?php if(isset($_REQUEST['facebook_id']) or isset($this->map['facebook_id'])){?><script type="text/javascript">document.getElementById('facebook_id').value = "<?php echo addslashes(URL::get('facebook_id',isset($this->map['facebook_id'])?$this->map['facebook_id']:''));?>";</script><?php }?></select>
                            <h2 class="card-inside-title">ID Page/Profile: </h2>
							<div class="input-group" style="margin-bottom: 0px;">
                                <div class="form-line">
                                     <input name="uid" class="form-control date" placeholder="Nhập ID của Page/Profile cần thả tim" required="" type="text">
                                </div>
                            </div><br/>		
							...
							if($key1!='current')
							{
								$this->map['item_reaction']['current'] = &$item1;?>
                                    <tr class="pending" data-action="<?php echo Url::build_current(array('cmd'=>'ajax_action_item'));?>" data-action-groups="<?php echo Url::build_current(array('cmd'=>'ajax_get_groups'));?>" data-id="<?php echo $this->map['item_reaction']['current']['id'];?>">
                                    	...
                                    	<td><a href="http://facebook.com/<?php echo $this->map['item_reaction']['current']['fid'];?>" target="_blank"><?php echo $this->map['item_reaction']['current']['name'];?></a></td>
                                        <td><?php echo $this->map['item_reaction']['current']['message'];?></td>
                                        <td><a href="http://facebook.com/<?php echo $this->map['item_reaction']['current']['uid'];?>" target="_blank"><?php echo $this->map['item_reaction']['current']['uid'];?></a></td>
