...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
		if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a javascript:void(0) onclick="ListModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Delete');?></a></td>
		<td class="form_title_button"><a href="<?php echo URL::build_current(array('package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'','name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('back');?></a></td><?php }else{ 
		if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('package_id','cmd'=>'update'));?>"><img src="skins/default/images/buttons/make_cache_button.gif" style="text-align:center"/><br /><?php echo Portal::language('update');?></a></td>
	<td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'delete_cache'));?>"><img src="skins/default/images/buttons/delete_cache_button.gif" style="text-align:center"/><br /><?php echo Portal::language('delete_module_cache');?></a></td><?php }?><?php 
		if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('type','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'','name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add'));?>"><img src="skins/default/images/buttons/add_button.gif" style="text-align:center" alt=""/><br /><?php echo Portal::language('Add');?></a></td><?php }?><?php 
		if(User::can_delete()){?>
	<td class="form_title_button"><a javascript:void(0) onclick="ListModuleAdminForm.cmd.value='delete';ListModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />
			<?php echo Portal::language('Delete');?></a></td>
	<?php }}?>
				<td class="form_title_button"><a  href="<?php echo URL::build('default');?>"><img src="skins/default/images/buttons/frontpage.gif" alt=""/><br />
						Trang ch&#7911;</a></td></tr></table>
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'',  
							  ...
							  <td width="24px" align="center">
								<a href="<?php echo Url::build('module_setting',array('module_id'=>$this->map['items']['current']['id'])); ?>"><img src="skins/default/images/buttons/information.png" alt="<?php echo Portal::language('Setting');?>" width="12" height="12" border="0"></a></td>
							<?php
							}
							?>						</tr>
			...
			<td width="100%">
				...
				<a javascript:void(0) onclick="select_all_checkbox(ListModuleAdminForm,'ModuleAdmin',true,'#FFFFEC','white');"><?php echo Portal::language('select_all');?></a>&nbsp;
				<a javascript:void(0) onclick="select_all_checkbox(ListModuleAdminForm,'ModuleAdmin',false,'#FFFFEC','white');"><?php echo Portal::language('select_none');?></a>
				<a javascript:void(0) onclick="select_all_checkbox(ListModuleAdminForm,'ModuleAdmin',-1,'#FFFFEC','white');"><?php echo Portal::language('select_invert');?></a>
			</td>
			<td>
