            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							if($key1!='current')
							{
								$this->map['items']['current'] = &$item1;?>
                                    <tr role="row">
                                        ...
                                        <td>
                                        <?php if($this->map['items']['current']['type']=='Up Top Group'){?>
                                        <a href="http://facebook.com/<?php echo $this->map['items']['current']['groupid'];?>" target="_blank">Up Top Group <?php echo $this->map['items']['current']['message'];?>&nbsp;</a>
                                        <?php }elseif($this->map['items']['current']['groupid']){?>
                                      Thêm <a href="http://facebook.com/<?php echo $this->map['items']['current']['uid'];?>" target="_blank"><?php echo $this->map['items']['current']['uid_name'];?></a> vào <a href="http://facebook.com/<?php echo $this->map['items']['current']['groupid'];?>" target="_blank"><?php echo $this->map['items']['current']['group_name'];?></a>
										<?php }else{?>
                                        <a href="http://facebook.com/<?php echo $this->map['items']['current']['uid'];?>" target="_blank"><?php echo $this->map['items']['current']['uid_name'];?></a>
                                        <?php }?>
                                        </td>
                                        <td><?php echo $this->map['items']['current']['type'];?></td>
                                        <td><?php echo $this->map['items']['current']['time_post_show'];?></td>
                                        <td title="<?php echo $this->map['items']['current']['message_error'];?>"><?php echo SchedulesGroup::status_post($this->map['items']['current']['status']);?></td>
					...
					unset($this->map['items']['current']);
                                    ...
                                    <tr>
                                    	<td colspan="7">Có tổng <b style="color:#F00"><?php echo $this->map['total'];?></b> - <?php echo $this->map['paging'];?></td>
                                    </tr>                                
                                </tbody>
                            </table>
                        </div>
