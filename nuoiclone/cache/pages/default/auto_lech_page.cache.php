...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '472',
      'name' => 'AutoLechPage',
      'path' => 'packages/frontend/modules/AutoLechPage/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '4',
  ...
  'help_id' => '0',
  'name' => 'auto_lech_page',
  'title_1' => 'Tự động lấy bài đăng của page khác',
  'description_1' => '',
  'customer_id' => '0',
  'read_only' => '0',
  'show' => '1',
  ...
  'is_use_sapi' => '0',
  'keyword_1' => '',
  'title' => 'Tự động lấy bài đăng của page khác',
  'keyword' => '',
  'description' => '',
);
...
<?php $blocks[13046]['object']->on_draw();?>
<?php $blocks[13047]['object']->on_draw();?></div>
 <!-- Modal Save-->
