...
$blocks = array (
  ...
  array (
    ...
    'settings' => 
    array (
      '308_html' => '<section class="content">
            ...
            <div class="row">
	            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <i class="fa fa-user" aria-hidden="true"></i> Tài khoản đã hết thời gian sử dụng. Vui lòng nâng cấp để sử dụng tiếp dịch vụ
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row">
...
<?php $blocks[13043]['object']->on_draw();?>
<?php $blocks[13050]['object']->on_draw();?></div>
 <!-- Modal Save-->
