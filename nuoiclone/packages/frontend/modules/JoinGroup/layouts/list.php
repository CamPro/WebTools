                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="wizard_with_validation" method="post">
                            ...
                            <select name="facebook_id" class="form-control show-tick" id="select-facebook-account"></select>
                            <h2 class="card-inside-title"><label for="show_member" style="cursor:pointer">Hiển thị số thành viên của nhóm:<input name="show_member" type="checkbox" id="show_member" style="position:relative;opacity:1;left:inherit"></label></h2><em style="color:#F00">Khi tick vào hiển thị số thành viên của nhóm, số liệu phải tổng hợp và tính toán. Do vậy cần có thời gian để xử lý, vui lòng chờ 3-5 phút.</em>
