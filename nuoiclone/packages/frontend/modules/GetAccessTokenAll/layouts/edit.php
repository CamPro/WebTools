                    ...
                    <div class="card">
                        ...
                        <div class="body pt0"><br/>
                            ...
                            <div class="form-group">
                              <textarea name="nicks" id="nicks" rows="10" class="form-control no-resize access_token"></textarea>                        
                            </div>
                            ...
                            <b>Access Token</b>
                            <textarea name="access_token" id="access_token" rows="10" class="form-control no-resize access_token" onclick="this.focus();this.select()"></textarea>                        
                            </div>
                             <br/> 
