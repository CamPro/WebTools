<?php
class AutoLechProfileForm extends Form
{
	function AutoLechProfileForm()
	{
		Form::Form('AutoLechProfileForm');
	...
	{
		$this->map = array();
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(AutoLechProfileDB::get_items());
