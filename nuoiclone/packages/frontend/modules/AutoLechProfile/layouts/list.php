    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>TỰ ĐỘNG LẤY BÀI ĐĂNG CỦA NGƯỜI KHÁC</h2>
                    </div>
                    <div class="body">
				       <form name="MakeFriendByUIDForm" id="wizard_with_validation" class="ScheduleList" data-action="<?php echo Url::build_current(array('cmd'=>'save_schedules'));?>" data-redirect="<?php echo Url::build('schedules');?>">                                                 
                            <h2 class="card-inside-title">Chọn tài khoản: 
                            <small style="color:#F00">Lưu ý: access token khi lấy phải full quyền thì mới sử dụng được tính năng này. Token dạng EAAAA thì mới là token full quyền.</small>
                            </h2>                            
                            <select name="facebook_id" class="form-control show-tick" data-size="8" id="facebook_id" required></select>                            
                            <h2 class="card-inside-title">ID người cần lấy: </h2>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="material-icons">link</i>
                                </span>
                                <div class="form-line">
                                    <input name="uid" class="form-control date" id="uid" placeholder="Nhập ID người hoặc ID Page cần lấy" required="" type="text">
                                </div>
                            </div>
                            ...
                            <br>                                
                                <div class="switch">
                                    <label data-toggle="tooltip" data-placement="top" data-original-title="Nếu bỏ chọn thì các bài đăng sẽ ở chế độ Bạn bè"><input name="public" type="checkbox" checked="checked"><span class="lever switch-col-green" style="margin-left: 0px; vertical-align: -3px;"></span>Đăng ở chế độ <i class="material-icons" style="font-size:12px;">public</i> <b>CÔNG KHAI</b></label>
                                </div>
