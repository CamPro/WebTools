<?php
class AutoAcceptFriendForm extends Form
{
	function AutoAcceptFriendForm()
	{
		Form::Form('AutoAcceptFriendForm');
	...
	{
		$this->map = array();
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(AutoAcceptFriendDB::get_items());
		$this->map['sex_list'] = array('0'=>'Tất cả','male'=>'Nam','female'=>'Nữ');
