<?php
class AddMemGroupForm extends Form
{
	function AddMemGroupForm()
	{
		Form::Form('AddMemGroupForm');
	...
	{
		$this->map = array();
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(AddMemGroupDB::get_items());
