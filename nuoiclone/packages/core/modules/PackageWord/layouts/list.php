...
?>
	...
	<tr><td>
		<img alt="" src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle"/>
	</td>
	...
	<td class="form_title_button" nowrap="nowrap">
		<a  onclick="ListPackageWordForm.submit();">
			<img alt="" src="skins/default/images/buttons/save_button.gif"/>
			<br />[[.Save.]]
		</a>
	</td>
	<?php }
	if(User::can_delete()){?>
	<td class="form_title_button" nowrap="nowrap">
		<a  onclick="if(confirm('[[.delete_confirm_question.]]?')){ListPackageWordForm.cmd.value='delete';ListPackageWordForm.submit();}"><img alt="" src="skins/default/images/buttons/delete.gif"/><br />[[.Delete.]]</a></td><?php }
	?>
	</tr>
	</table>
...
<div class="form_bound">
	...
	<div class="form_content">
		...
		<table width="99%" cellpadding="1" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#C9C08F" id="main_table">
			<thead>
			<tr valign="middle" bgcolor="#E4E0C9" style="line-height:20px">
			...
			<tr valign="middle" id="PackageWord_tr_[[|items.id|]]" onclick="edit_row(this,'[[|items.id|]]');">
				...
				<td nowrap >
					...
					<!--/LIST:languages--><td nowrap align="left"><div class="normal_input_text" id="package_id_[[|items.id|]]">[[|items.package_id|]]</div></td><td nowrap ><div class="normal_input_text" id="time_[[|items.id|]]"><?php echo date('d/m/Y',intval([[=items.time=]]));?></div></td>
			</tr>
			<!--/LIST:items-->
			</tbody>
		</table>
		...
		<input type="submit" value="  [[.save.]]  " onclick="if(check_error())this.form.submit();">
		</div>
		<table width="100%"><tr>
		<td width="100%">
			[[.select.]]:&nbsp;
		...
		<td>
			<a name="bottom_anchor" javascript:void(0)><img alt="" src="skins/default/images/top.gif" title="[[.top.]]" border="0" alt="[[.top.]]"></a>
		</td>
		</tr></table>
