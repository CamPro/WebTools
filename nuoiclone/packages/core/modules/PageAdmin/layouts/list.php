...
<table cellpadding="0" width="100%">
	<tr>
		...
		<?php if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a javascript:void(0) onclick="ListPageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt="" width="20" height="20" style="text-align:center"/><br />[[.Delete.]]</a></td><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br />[[.back.]]</a></td><?php }else{ 
		if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id','cmd'=>'delete_all_cache'));?>"><img src="skins/default/images/buttons/delete_cache_button.gif" style="text-align:center"/><br />[[.delete_cache.]]</a></td><?php } 
		if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add'));?>"><img src="skins/default/images/buttons/add_button.gif" style="text-align:center" alt=""/><br />[[.Add.]]</a></td><td class="form_title_button" align="center"><a href="<?php echo URL::build_current(array('portal_id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'', 'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add_blocks'));?>"><img src="skins/default/images/buttons/add.jpg" style="text-align:center" alt=""/><br />[[.Add_block.]]</a></td><?php }?><?php if(User::can_delete()){?>
        <td class="form_title_button">
				<a javascript:void(0) onclick="ListPageAdminForm.cmd.value='delete';ListPageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a>
            </td><?php }}?>
            <td class="form_title_button">
				...
				<td width="100%">
					...
					<table width="99%" cellpadding="2" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#CCCCCC">
						...
						<tr bgcolor="<?php if((URL::get('just_edited_id',0)==[[=items.id=]]) or (is_numeric(array_search(MAP['items']['current']['id'],MAP['just_edited_ids'])))){ echo '#EFFFDF';} else {echo [[=items.is_sibling=]]?'#FFFFDF':'white';}?>" valign="middle" <?php Draw::hover('#E2F1DF');?> style="cursor:pointer;" id="PageAdmin_tr_[[|items.id|]]">
							...
							<td><a target="_blank" href="<?php echo URL::build([[=items.name=]]);?>&[[|items.params|]]"><img src="skins/default/images/buttons/select.jpg" /></a></td>
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'',    
	  						...
	  						<td nowrap><a href="<?php echo Url::build_current(array('portal_id','package_id', 'name')+array('cmd'=>'duplicate','id'=>[[=items.id=]])); ?>"><img src="skins/default/images/buttons/duplicate.gif" alt="[[.duplicate.]]" width="13" height="13" border="0"></a></td>
							<?php
							}
							?>						</tr>
						<!--/LIST:items-->
...
<!--IF:delete(URL::get('cmd')=='delete')-->
			...
			<td width="100%">
				[[.select.]]:&nbsp;
				<a javascript:void(0) onclick="select_all_checkbox(document.ListPageAdminForm,'PageAdmin',true,'#FFFFEC','white');">[[.select_all.]]</a>&nbsp;
				<a javascript:void(0) onclick="select_all_checkbox(document.ListPageAdminForm,'PageAdmin',false,'#FFFFEC','white');">[[.select_none.]]</a>
				<a javascript:void(0) onclick="select_all_checkbox(document.ListPageAdminForm,'PageAdmin',-1,'#FFFFEC','white');">[[.select_invert.]]</a>
			</td>
			<td>
