<?php
System::set_page_title(Portal::get_setting('website_title','').' [[.language.]]'.[[=name=]]);
?>
...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/language_button.gif" align="absmiddle"/>[[.language.]] [[|name|]]</td>
			<td class="form_title_button"><a javascript:void(0) onclick="ListModuleWordForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td>
			<td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'view','id','package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'','name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br />[[.back.]]</a></td>
			<td class="form_title_button"><a target="_blank" href="<?php echo URL::build_current(array('cmd'=>'export','module_id'=>URL::get('id')));?>"><img src="skins/default/images/buttons/export_button.gif" style="text-align:center"/><br />[[.export.]]</a></td>
			<td class="form_title_button"><a  href="<?php echo URL::build('default');?>"><img src="skins/default/images/buttons/frontpage.gif" alt=""/><br />Trang ch&#7911;</a></td></tr></table>
<div class="form_content">
  ...
  <?php
	foreach(MAP['words'] as $word=>$word_text)
	{
		...
		{
			echo '<td valign="top"><a href="'.URL::build_current(array('cmd'=>'delete_word')).'&id='.$word_text['id'].'"><img src="skins/default/images/buttons/delete.gif" alt="X&oacute;a" width="12" height="12" border="0"></a></td>';
		}
		echo '</tr>';
	}
  ?>  		</tr>
