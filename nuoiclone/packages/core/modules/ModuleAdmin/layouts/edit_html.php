...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?> module [[|name|]]</td><td class="form_title_button"><a javascript:void(0) onclick="EditModuleHTMLAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td><td>&nbsp;</td>
		<td class="form_title_button">
			<a javascript:void(0) onclick="location='<?php echo URL::build_current();?>';"><img src="skins/default/images/buttons/go_back_button.gif"/><br />[[.back.]]</a></td>
		<?php if($action=='edit'){?><td class="form_title_button">
			<a javascript:void(0) onclick="location='<?php echo URL::build_current(array('cmd'=>'edit','id'));?>';"><img src="skins/default/images/buttons/edit_button.gif"/><br />[[.Edit.]]</a></td><?php }?>
		<td class="form_title_button">
