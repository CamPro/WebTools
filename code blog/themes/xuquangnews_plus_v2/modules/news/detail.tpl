...
<div class="news_column panel panel-default">
	<div class="panel-body other-news">
    	...
    	<!-- BEGIN: related_new -->
    	<div class="col-md-12">        
            <p class="h3"><i class="fa fa-thumbs-o-up" aria-hidden="true">
            </i>&nbsp;&nbsp;<strong>{LANG.related_new}</strong>&nbsp;<span class="icon_new">&nbsp;</span></p>            
            <div class="clearfix">            
                <ul class="related">               
                    <!-- BEGIN: loop -->        
                    <li class="clearfix">                               <li>                                        
                        <a href="{RELATED_NEW.link}" 
                        <!-- BEGIN: tooltip -->data-content="{RELATED_NEW.hometext}" data-img="{RELATED_NEW.imghome}" data-rel="tooltip" data-placement="{TOOLTIP_POSITION}"<!-- END: tooltip --> title="{RELATED_NEW.title}">
                        <img src="{RELATED_NEW.imghome}" alt="{RELATED_NEW.title}" width="65" class="img-thumbnail pull-left " />{RELATED_NEW.title}</a>                                     <em>({RELATED_NEW.time})</em>               </li>               
                        <!-- END: loop -->          
                    </ul>            
                </div>        
            </div>
    	...
    	<!-- BEGIN: related -->
    	<div class="col-md-12">        
            <p class="h3"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>&nbsp;&nbsp;<strong>{LANG.related}</strong></p>              
            <div class="clearfix">               
                <ul class="related">              
                    <!-- BEGIN: loop -->                
                    <li class="clearfix">               <li>                    <a href="{RELATED.link}" 
                        <!-- BEGIN: tooltip -->data-content="{RELATED.hometext}" data-img="{RELATED.imghome}" data-rel="tooltip" data-placement="{TOOLTIP_POSITION}"
                        <!-- END: tooltip --> title="{RELATED.title}">
                        <img src="{RELATED.imghome}" alt="{RELATED.title}" width="65" class="img-thumbnail pull-left " />{RELATED.title}</a>                             
                        <!-- BEGIN: newday -->                  
                        <span class="icon_new">&nbsp;</span>                    
                        <!-- END: newday -->                
                    </li>               
