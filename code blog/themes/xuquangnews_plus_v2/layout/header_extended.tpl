    ...
    <div class="body-bg">
        ...
        <header>
            <div class="container" style="width:100%">
                ...
                <div class="wraper">
                    <div class="logo col-xs-24 col-sm-6 col-md-6">
                        <!-- BEGIN: image -->
                        <a title="{SITE_NAME}" href="{THEME_SITE_HREF}"><img src="/themes/xuquangnews_plus_v2/images/pendalogo.png" width="180px" height="54px" alt="{SITE_NAME}" /></a>
                        <!-- END: image -->
                        <!-- BEGIN: swf -->
                    ...
                    <div class="col-xs-24 col-sm-18 col-md-18 banneradv">
