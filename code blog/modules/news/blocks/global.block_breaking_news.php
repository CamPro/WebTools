...
if (! nv_function_exists('nv_block_news_breaking')) {
    function nv_block_config_news_breaking($module, $data_block, $lang_block)
    {
    ...
    function nv_block_config_news_breaking_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_news_breaking($block_config)
    {
        ...
        if (! empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/news/block_breaking_news.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }
            $xtpl = new XTemplate('block_breaking_news.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/news');
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_news_breaking($block_config);
    }
}
