...
class EditPrivilegeForm extends Form
{
	...
	function on_submit()
	{
		...
		if($this->check() and URL::get('confirm_edit'))
		{
			...
			Url::redirect_current(array('package_id'=>isset($_GET['package_id'])?$_GET['package_id']:'','cmd'=>'grant','id'=>$id));
		}
	}	
	function draw()
	{	
		...
		$this->parse_layout('edit',
			...
			'status_list'=>$status,
			'category_id_list'=>array('0'=>Portal::language('all'))+String::get_list($categories)
			)
		);
	}
}
