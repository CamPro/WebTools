...
<form method="post" name="SearchModuleSettingForm" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
	...
	<td class="form_title_search" nowrap="nowrap">
		Module: <select name="module_id" onchange="location='<?php echo URL::build('module_setting');?>&module_id='+this.value;"></select>
	</td>
	<?php 
		if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a javascript:void(0) onclick="$('cmd').cmd='delete';ListModuleSettingForm.submit();"><img src="skins/default/images/buttons/delete.jpg" alt="" width="16" height="16" class="icon_cmd"/>[[.Delete.]]</a></td>
			<td class="form_title_button"><a href="<?php echo URL::build_current(array('module_id'=>isset($_GET['module_id'])?$_GET['module_id']:'', 
	));?>"><img alt="" src="skins/default/images/buttons/back.jpg" class="icon_cmd"/>[[.back.]]</a></td><?php 
		}else{ 
			if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('module_id','cmd'=>'add','name', 'description', 'type', 'default_value', 'value_list', 'style','edit_condition', 'view_condition', 'extend', 'group_name', 'position', 'meta', 'group_column', 'update_code'));?>"><img alt="" src="skins/default/images/buttons/add.jpg" style="text-align:center" class="icon_cmd"/>[[.Add.]]</a></td><?php }?><?php 
			if(User::can_delete()){?><td class="form_title_button"><a javascript:void(0) onclick="ListModuleSettingForm.cmd.value='delete';ListModuleSettingForm.submit();"><img alt="Delete" src="skins/default/images/buttons/delete.jpg" class="icon_cmd"/>[[.Delete.]]</a></td><?php }
		}?></tr></table>
</form>	
