...
System::set_page_title(Portal::get_setting('website_title','').' '.$title);?><div class="form_bound">
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><td class="form_title_button"><a href="javascript:void(0)" onclick="EditPageAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td><td>&nbsp;</td>
		<td class="form_title_button">
			<a href="javascript:void(0)" onclick="location='<?php echo URL::build_current(array('portal_id','package_id'));?>';"><img src="skins/default/images/buttons/go_back_button.gif"/><br />[[.back.]]</a></td>
		<?php if($action=='edit'){?><td class="form_title_button">
			<a href="javascript:void(0)" onclick="location='<?php echo URL::build_current(array('portal_id','package_id','cmd'=>'delete','id'));?>';"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a></td><?php }?>
		<td class="form_title_button">
