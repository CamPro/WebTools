	...
	function draw_list($region, $items)
	{
		...
		foreach ($items as $key=>$item)
		{
			...
			if($i)
			{
				...
				$last['move_down'] = '<a href="'.Url::build('edit_page',array('block_id'=>$last['id'],'move'=>'down','container_id')).'"><img src="skins/default/images/buttons/down_arrow.gif" alt="Move down"></a>';
			}
			$i++;
		...
		if($i>1)
		{
			$items[$key]['move_up']='<a href="'.Url::build('edit_page',array('id','block_id'=>$item['id'],'move'=>'up','container_id')).'"><img src="skins/default/images/buttons/up_arrow.gif" alt="Move up"></a>';
		}
