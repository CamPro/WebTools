...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a javascript:void(0) onclick="ModuleAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td><?php }else{ if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'edit','id'));?>"><img src="skins/default/images/buttons/edit.jpg" style="text-align:center" alt=""/><br />[[.Edit.]]</a></td><?php } if(User::can_delete()){?><td class="form_title_button">
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'',  
	  ));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br />[[.back.]]</a></td>
