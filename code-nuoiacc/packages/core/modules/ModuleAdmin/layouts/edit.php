...
<table cellpadding="0" width="100%"><tr><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><td class="form_title_button"><a href="javascript:void(0)" onclick="EditModuleAdminForm.submit();"><img src="skins/default/images/buttons/save_button.gif" style="text-align:center"/><br />[[.save.]]</a></td><?php if($action=='edit'){?><td class="form_title_button"><a href="javascript:void(0)" onclick="location='<?php echo URL::build_current(array('cmd'=>([[=type=]]=='CONTENT')?'edit_content':(([[=type=]]=='HTML')?'edit_html':'edit_code'),'id'));?>';"><img width="30px" src="skins/default/images/buttons/edit_button.gif" style="text-align:center"/><br />[[.edit_code.]]</a></td><?php }?>
		<td class="form_title_button">
			<a href="javascript:void(0)" onclick="location='<?php echo URL::build_current();?>';"><img src="skins/default/images/buttons/go_back_button.gif"/><br />[[.back.]]</a></td>
		<?php if($action=='edit'){?><td class="form_title_button">
			<a href="javascript:void(0)") onclick="location='<?php echo URL::build_current(array('cmd'=>'delete','id'));?>';"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a></td><?php }?>
		<td class="form_title_button">
