...
<table cellpadding="0" width="100%"><tr valign="bottom"><td  class="form_title"><img src="skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle" alt=""/><?php echo $title;?></td><?php 
	if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a javascript:void(0) onclick="ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td>
	<td class="form_title_button"><a href="<?php echo URL::build_current(array('name'=>isset($_GET['name'])?$_GET['name']:''));?>"><img src="skins/default/images/buttons/go_back_button.gif" style="text-align:center" alt=""/><br />[[.back.]]</a></td><?php }
	else{ if(User::can_add()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array(	'name'=>isset($_GET['name'])?$_GET['name']:'')+array('cmd'=>'add'));?>"><img src="skins/default/images/buttons/add_button.gif" style="text-align:center" alt=""/><br />[[.Add.]]</a></td><?php }?><?php 
	if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'make_library_cache'));?>"><img src="skins/default/images/buttons/make_cache_button.gif" style="text-align:center"/><br />[[.make_cache.]]</a></td>
	...
	if(User::can_delete()){?><td class="form_title_button">
				<a javascript:void(0) onclick="ListPackageAdminForm.cmd.value='delete';ListPackageAdminForm.submit();"><img src="skins/default/images/buttons/delete_button.gif" alt=""/><br />[[.Delete.]]</a></td><?php }}?>
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'', 
	  )+array('cmd'=>'edit','id'=>[[=items.id=]])); ?>"><img src="skins/default/images/buttons/edit.gif" alt="[[.Edit.]]" width="12" height="12" border="0"></td></a>
							<?php
							}
