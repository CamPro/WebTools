...
if (USE_ACCESS_KEYS == TRUE){
	if (!isset($_GET['akey'], $access_keys) || empty($access_keys)){
		die('<center>
<p>Xin chào, bạn đang truy cập trái phép thư mục của chúng tôi từ Ip: '.$_SERVER['REMOTE_ADDR'].'</p>
<p>Chúng tôi đã lưu lại thông tin ip, địa chỉ, tên máy,... của bạn để xử lý trong trường hợp cần thiết!</p>
</center>');
	}
