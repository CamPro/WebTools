<?php
class AutoMakeFriendForm extends Form
{
	function AutoMakeFriendForm()
	{
		Form::Form('AutoMakeFriendForm');
	...
	{
		$this->map = array();
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(AutoMakeFriendDB::get_items());
