                                        ...
                                        <div class="col-sm-12 mb0">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea name="access_token" id="access_token" rows="4" class="form-control no-resize access_token" placeholder="Nếu bạn đã có sẵn Access Token chỉ cần copy/paste vào đây rồi ấn Ghi lại."></textarea>
                                                    </div>
                                                </div>                                                
