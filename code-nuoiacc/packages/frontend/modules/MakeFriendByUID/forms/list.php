<?php
class MakeFriendByUIDForm extends Form
{
	function MakeFriendByUIDForm()
	{
		Form::Form('MakeFriendByUIDForm');
	...
	{
		$this->map = array();
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(MakeFriendByUIDDB::get_items());
