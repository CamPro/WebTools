<?php
class JoinGroupByUIDForm extends Form
{
	function JoinGroupByUIDForm()
	{
		Form::Form('JoinGroupByUIDForm');
	...
	function draw()
	{
		...
		$this->map['facebook_id_list'] = array('0'=>'-- Ấn vào đây để chọn tài khoản --')+String::get_list(JoinGroupByUIDDB::get_items($cond));
