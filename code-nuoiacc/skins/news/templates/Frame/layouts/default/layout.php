<div class="frame-default-bound" <?php if(Module::get_setting('extra_css_bound')){ echo 'style="'.Module::get_setting('extra_css_bound').'"'; }?> >
    <div class="frame-default-title" <?php if(Module::get_setting('title_color')){echo 'style="color:'.Module::get_setting('title_color').';"';}?>>
    ...
    <div class="frame-default-content-bound">
        <div class="frame-default-content-left">
            <div class="frame-default-content-right">
	            <div class="frame-default-content">{{-content-}}</div>
            </div></div></div>
    <div class="frame-default-bottom"><div class="frame-default-bottom-left"><div class="frame-default-bottom-right"></div></div></div>
</div>
<div class="clear"></div>