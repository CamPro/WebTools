        ...
        <div class="body">
			 ...
			 <div class="register">
                <form action="<?php echo Url::build_current(array('cmd'=>'forgot_password'));?>" data-redirect="<?php echo Url::build_current(array('act'=>'forgot_password'));?>">
                	...
                	<div class="input-group">
                      ...
                      <div class="col-xs-4">
                    	<input  name="ref" id="ref" type ="hidden" value="<?php echo String::html_normalize(URL::get('ref'));?>"/>
            ...
            <div class="msg"><?php echo Portal::get_setting('website_description');?></div>
                <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text" class="form-control" name="email" placeholder="<?php echo Portal::language('Email');?>" required="" autofocus="" value="demo@gpcorp.vn">
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
