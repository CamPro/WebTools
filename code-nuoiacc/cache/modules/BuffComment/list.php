                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form id="wizard_with_validation" method="post">
                            ...
                            <textarea  name="message" id="message" rows="10" class="form-control no-resize" placeholder="Nội dung cần comment"><?php echo String::html_normalize(URL::get('message',''));?></textarea>
                            </div>
