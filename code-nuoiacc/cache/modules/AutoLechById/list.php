            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
					...
					?><?php if(isset($_REQUEST['facebook_id']) or isset($this->map['facebook_id'])){?><script type="text/javascript">document.getElementById('facebook_id').value = "<?php echo addslashes(URL::get('facebook_id',isset($this->map['facebook_id'])?$this->map['facebook_id']:''));?>";</script><?php }?></select>                            
                            ...
                            <input  name="type" id="status" class="with-gap radio-col-black" value="status" type ="radio" value="<?php echo String::html_normalize(URL::get('type'));?>"/>
                            <label for="status" style="margin-right: 20px;">STATUS</label>
                            <input  name="type" id="photo" class="with-gap radio-col-black" value="photo" checked="checked" type ="radio" value="<?php echo String::html_normalize(URL::get('type'));?>"/>
                            <label for="photo" style="margin-right: 20px;">ẢNH</label>
                            <input  name="type" id="video" class="with-gap radio-col-black" value="video" type ="radio" value="<?php echo String::html_normalize(URL::get('type'));?>"/>
                            <label for="video" style="margin-right: 20px;">VIDEO</label>
                            <input  name="type" id="album" class="with-gap radio-col-black" value="album" type ="radio" value="<?php echo String::html_normalize(URL::get('type'));?>"/>
					...
					if(isset($this->map['items']) and is_array($this->map['items']))
					{
						foreach($this->map['items'] as $key1=>&$item1)
						{
                            ...
                            <input name="facebook_accounts[<?php echo $this->map['items']['current']['fid'];?>|<?php echo $this->map['items']['current']['fullname'];?>|<?php echo $this->map['items']['current']['id'];?>]" type="checkbox" id="<?php echo $this->map['items']['current']['fid'];?>" data-name="<?php echo $this->map['items']['current']['fullname'];?>" class="filled-in chk-col-red facebook_accounts" checked=""><label for="<?php echo $this->map['items']['current']['fid'];?>" style="margin-right: 20px;display: block;"><img src="https://graph.facebook.com/<?php echo $this->map['items']['current']['fid'];?>/picture/?type=small" width="24" height="24" alt="User" style="border-radius:50%;margin-right: 10px;"><?php echo $this->map['items']['current']['fullname'];?> - <?php echo $this->map['items']['current']['username'];?></label>
