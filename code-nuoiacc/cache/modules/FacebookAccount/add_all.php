                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <textarea  name="access_token" id="access_token" rows="16" class="form-control no-resize access_token" placeholder="Copy/paste Access Token vào đây rồi ấn Ghi lại. Mỗi Access Token trên 1 dòng. Nhấn Enter để xuống dòng."><?php echo String::html_normalize(URL::get('access_token',''));?></textarea>
                                            </div>
                                        </div>                                                
