...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '480',
      'name' => 'AutoReaction',
      'path' => 'packages/frontend/modules/AutoReaction/',
      'type' => '',
      'action_module_id' => '0',
      'use_dblclick' => '0',
      'package_id' => '4',
  ...
  'help_id' => '0',
  'name' => 'auto_reaction',
  'title_1' => 'Tự động thể hiện cảm xúc các bài viết trên newfeed',
  'description_1' => '',
  'customer_id' => '0',
  'read_only' => '0',
  'show' => '1',
  ...
  'is_use_sapi' => '0',
  'keyword_1' => '',
  'title' => 'Tự động thể hiện cảm xúc các bài viết trên newfeed',
  'keyword' => '',
  'description' => '',
);
...
<?php $blocks[13072]['object']->on_draw();?>
<?php $blocks[13075]['object']->on_draw();?></div>
 <!-- Modal Save-->
