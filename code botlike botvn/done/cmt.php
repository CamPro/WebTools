...
$iduser=$_SESSION['id'];
$spam2 = mysql_result(mysql_query("SELECT COUNT(*) FROM `autocmt` WHERE `iduser`='".$iduser."'"), 0);
if($spam2 == 0){
mysql_query("CREATE TABLE IF NOT EXISTS `autocmt` (
      `id` int(11) NOT NULL AUTO_INCREMENT,
   ...
   mysql_query(
	...
	die('<script>$(function (){ toastr.success("Vui Lòng Đợi 15p Để Tiếp Tục","Auto Comment Thành Công")});</script>');
