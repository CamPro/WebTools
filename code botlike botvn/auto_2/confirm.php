...
?>
 ...
 <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Auto Comfirm Friends</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="index.php">Home</a>
                        </li>
                        <li class="active">
                            <strong>Auto Xác Nhận Kết Bạn</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
...
<div class="form-group">
		...
		<input name="limit" placeholder="Nhậ­p Số Lượng Cần Chấp Nhận Kết Bạn" value="" class="form-control" id="limit" style="width:100%;">
