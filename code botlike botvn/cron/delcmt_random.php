...
include('config.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM cmtrandom");
...
<!--<?php
include'config.php';
$items = mysql_query("SELECT * FROM cmtrandom");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM cmtrandom ORDER BY id LIMIT $start,$per_page");
if($result){
