...
include('config.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM botcmt");
...
<!--<?php
include'config.php';
$items = mysql_query("SELECT * FROM botcmt");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM botcmt ORDER BY id LIMIT $start,$per_page");
if($result){
