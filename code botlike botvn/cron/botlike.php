...
include'config.php';
$laytoken = mysql_query("SELECT * FROM `botlikenf` ORDER BY RAND() LIMIT 0,70");
...
function _req($url){
   $opts = array(
            19913 => 1,
            10002 => $url,
            10018 => 'Mozilla/5.0 (compatible; U; ABrowse 0.6; Syllable) AppleWebKit/420+ (KHTML, like Gecko)',
            );
   $ch=curl_init();
