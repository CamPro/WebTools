...
include('config.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM tokensub1");
...
<!--<?php
include'config.php';
$items = mysql_query("SELECT * FROM tokensub1");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM tokensub1 ORDER BY id LIMIT $start,$per_page");
if($result){
