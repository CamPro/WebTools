...
include('config.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM botlikenf");
...
<!--<?php
include'config.php';
$items = mysql_query("SELECT * FROM botlikenf");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM botlikenf ORDER BY id LIMIT $start,$per_page");
if($result){
