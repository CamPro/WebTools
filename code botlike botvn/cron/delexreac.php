...
include('config.php');
//count member
$babi = mysql_query ("SELECT name, COUNT(name) FROM exreac");
...
<!--<?php
include'config.php';
$items = mysql_query("SELECT * FROM exreac");
$thispage = $PHP_SELF;
...
$result = mysql_query("SELECT * FROM exreac ORDER BY id LIMIT $start,$per_page");
if($result){
